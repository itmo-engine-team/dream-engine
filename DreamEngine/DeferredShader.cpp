...
bool DeferredShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"../TestGame/Shaders/ShaderDeferred.fx");
	if (!result)
	{
		return false;
	}
...
bool DeferredShader::InitializeShader(ID3D11Device* device, HWND hwnd, const wchar_t* fxFileName)
{
	HRESULT result;
	...
	result = D3DCompileFromFile(shaderPath.c_str(), nullptr, nullptr, "DeferredVertexShader", "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
	...
	result = D3DCompileFromFile(fxFileName, NULL, NULL, "DeferredPixelShader", "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0,
...
bool DeferredShader::SetShaderParameters(ID3D11DeviceContext* deviceContext, Matrix worldMatrix, Matrix viewMatrix,
