...
void KatamariGame::Init(InputSystem* inputSystem, Graphics* graphics)
{
    ...
    plane->AddComponent(new ACS_StaticModel(this, plane, new Transform({ 0, 0, 0 }), planeModel));
    gameAssetManager->AddActor(plane);

    box1 = new Actor(this, new Transform({ -1, 1, 0 }));
    box1->AddComponent(new ACS_StaticModel(this, box1, new Transform({ 0, 0, 0 }), boxModel));
    gameAssetManager->AddActor(box1);

    box2 = new Actor(this, new Transform({ -0.5, 1, -1 }));
    box2->AddComponent(new ACS_StaticModel(this, box2, new Transform({ 0, 0, 0 }), boxModel));
    gameAssetManager->AddActor(box2);

    box3 = new Actor(this, new Transform({ 1, 1, 0 }));
    box3->AddComponent(new ACS_StaticModel(this, box3, new Transform({ 0, 0, 0 }), boxModel));
    ...
    lightActor->AddComponent(new ACS_StaticModel(this, lightActor, new Transform({ 0, 0, 0 }), boxModel));
    lightActor->AddComponent(new ACS_StaticModel(this, lightActor, new Transform({ 0, 0, 0.5 }),
